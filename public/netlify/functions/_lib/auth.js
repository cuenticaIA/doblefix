...
export function getSessionFromEvent(event) {
  ...
  // Netlify Functions v2: headers is a Web API Headers object (use .get())
  // Netlify Functions v1: headers is a plain object (use direct access)
  const cookieHeader =
    typeof event.headers?.get === 'function'
